...
# run_and_log "python3 Federated/main.py --cfg Federated/config/ham10000_fednova_resnet50.yaml" "logs/ham10000_fedavg_resnet50.txt"
# run_and_log "python3 Federated/main.py --cfg Federated/config/ham10000_fedprox_resnet50.yaml" "logs/ham10000_fedavg_resnet50.txt"
# run_and_log "python3 Federated/main.py --cfg Federated/config/ham10000_fedsgd_resnet50.yaml"  "logs/ham10000_fedavg_resnet50.txt"
