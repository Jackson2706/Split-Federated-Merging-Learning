...
def main():
    ...
    json_path = f"/home/jackson/Desktop/Split-Federated-Merging-Learning/Figure/data/OursV1_{config['dataset']}_iid:{config['iid']}_{config['model']}_{config['num_users']} users_t1:{config['t1']}_t2:{config['t2']}.json"
