...
model_path = "/home/jackson/Desktop/Split-Federated-Merging-Learning/cifar10_iid:False_alexnet_20 users_t1:5_t2:10.pt"
batch_size = 128
n_components = 2
perplexity = 30
random_state = 42
...
plot_tsne(X_raw_tsne, y, "t-SNE of Raw Input Images", save_path="figures/tsne_rawnoniid.png")
plot_tsne(X_encoded_tsne, y, "t-SNE of Encoded Features", save_path="figures/tsne_encodednoniid.png")