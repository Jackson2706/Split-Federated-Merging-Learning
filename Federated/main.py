...
def main():
    ...
    for epoch in tqdm(range(config["epochs"])):
        ...
        for idx in idxs_users:
            local_update = get_client_update_strategy(config["strategy"])(args=config, dataset=train_dataset, idxs=user_groups[idx], logger=logger)
        ...
        global_weights = strategy.aggregate(local_updates, global_weights, local_weights)
        # update global weights
