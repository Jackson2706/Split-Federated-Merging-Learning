...
def main():
    ...
    plt.xlabel("Communication Rounds")
    plt.savefig(
        "./save/{}_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_f1.png".format(
            config["strategy"],
            config["dataset"],
            config["model"],
            config["epochs"],
    ...
    plt.xlabel("Communication Rounds")
    plt.savefig(
        "./save/{}_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_training_time.png".format(
            config["strategy"],
            config["dataset"],
            config["model"],
            config["epochs"],
    ...
    plt.xlabel("Communication Rounds")
    plt.savefig(
        "./save/{}_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_cpu_usage.png".format(
            config["strategy"],
            config["dataset"],
            config["model"],
            config["epochs"],
    ...
    plt.xlabel("Communication Rounds")
    plt.savefig(
        "./save/{}_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_ram_usage.png".format(
            config["strategy"],
            config["dataset"],
            config["model"],
            config["epochs"],
    ...
    plt.xlabel("Communication Rounds")
    plt.savefig(
        "./save/{}_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_gpu_ram_usage.png".format(
            config["strategy"],
            config["dataset"],
            config["model"],
            config["epochs"],
