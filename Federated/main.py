...
def main():
    ...
    with open(f'/home/jackson/Desktop/Split-Federated-Merging-Learning/Figure/data/{config["strategy"]}_{config["dataset"]}_iid:{config["iid"]}_{config["model"]}_{config["num_users"]} users.json', 'w') as f:
