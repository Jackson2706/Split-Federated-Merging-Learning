...
def main():
    ...
    print("|---- Test IOU: {:.2f}%".format(test_iou))
    print("|---- Test Dice: {:.2f}%".format(test_dice))
    ...
    with open(
        f"/home/jackson/Desktop/Split-Federated-Merging-Learning/classification/Figure/data/HierFL_{config['dataset']}_iid:{config['iid']}_{config['model']}_{config['num_users']} users.json",
        "w",
    ) as f:
