...
# Define the paths
json_paths = [
    "/home/jackson/Desktop/Split-Federated-Merging-Learning/classification/Figure/data/cifar_ours_output.json",
    "/home/jackson/Desktop/Split-Federated-Merging-Learning/classification/Figure/data/cifar_oursv2_output.json",
]
...
plt.tight_layout()
plt.savefig(
    f"/home/jackson/Desktop/Split-Federated-Merging-Learning/Figure/figures/cifar_{feature_name}_comparison.pdf",
    dpi=300,
    bbox_inches="tight",
)
